...
define( 'RSSEO_PRO_VERSION',        '1.9.0' );
...
class RSSEO_Pro_Plugin {
    ...
    private function includes() {
        ...
        require_once RSSEO_PRO_PATH . 'includes/class-rsseo-pro-content-brief.php';
        ...
        require_once RSSEO_PRO_PATH . 'includes/class-rsseo-pro-growth-digest.php';
    }
