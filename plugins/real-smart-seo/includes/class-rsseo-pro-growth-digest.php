...
class RSSEO_Pro_Growth_Digest {
    ...
    public function run_digest( $force = false ) {
        ...
        if ( ! class_exists( 'RSSEO_Claude_API' ) || ! method_exists( 'RSSEO_Claude_API', 'ask' ) ) {
            return new WP_Error( 'no_api', 'The base Midland Smart SEO plugin (Claude API) is unavailable.' );
        }
...
<table role="presentation" width="620" style="max-width:620px;width:100%;background:#fff;border-radius:12px;overflow:hidden;">
  ...
  <tr><td style="background:#f9f9f9;padding:16px 32px;">
    <p style="margin:0;font-size:12px;color:#aaa;">Generated by Midland Smart SEO. Reply to this email with what you actioned and we will tailor next time.</p>
  </td></tr>
    ...
    public function render_page() {
        ...
        <div class="wrap">
            ...
            <?php if ( ! $has_api ) : ?><div class="notice notice-warning"><p><?php esc_html_e( 'The free Midland Smart SEO base plugin (Claude API) must be active to generate the digest.', 'real-smart-seo-pro' ); ?></p></div><?php endif; ?>
