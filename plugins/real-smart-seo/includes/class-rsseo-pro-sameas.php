...
class RSSEO_Pro_SameAs {
    ...
    public function add_menu() {
        add_submenu_page(
            null,
            esc_html__( 'Business Identity', 'real-smart-seo' ),
            esc_html__( 'Business Identity', 'real-smart-seo' ),
            'manage_options',
            'rsseo-sameas',
    ...
    public function render_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e( 'Business Identity & sameAs', 'real-smart-seo' ); ?></h1>
            <p class="description">
                <?php esc_html_e( 'Connect your business to Google\'s Knowledge Graph. Every profile URL added here becomes a sameAs signal — Google cross-references them to confirm your entity and boost local rankings.', 'real-smart-seo' ); ?>
            </p>

            <?php if ( $saved ) : ?>
                <div class="notice notice-success is-dismissible"><p><?php esc_html_e( 'Business identity saved. Schema is now live in your page <head>.', 'real-smart-seo' ); ?></p></div>
            <?php endif; ?>

            <form method="post">
                <?php wp_nonce_field( 'rsseo_save_sameas', '_rsseo_sameas_nonce' ); ?>

                <h2><?php esc_html_e( 'Business Info', 'real-smart-seo' ); ?></h2>
                <table class="form-table">
                    <tr>
                        <th><label for="business_name"><?php esc_html_e( 'Business Name', 'real-smart-seo' ); ?></label></th>
                        <td><input type="text" id="business_name" name="business_name" class="regular-text" value="<?php echo esc_attr( $d['business_name'] ?? '' ); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="business_type"><?php esc_html_e( 'Schema Type', 'real-smart-seo' ); ?></label></th>
                        <td>
                            ...
                            <p class="description"><?php esc_html_e( 'Choose the most specific type. For floor/carpet cleaning use CleaningService.', 'real-smart-seo' ); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="business_description"><?php esc_html_e( 'Description', 'real-smart-seo' ); ?></label></th>
                    ...
                    <tr>
                        <th><label for="business_phone"><?php esc_html_e( 'Phone', 'real-smart-seo' ); ?></label></th>
                    ...
                    <tr>
                        <th><label for="business_email"><?php esc_html_e( 'Email', 'real-smart-seo' ); ?></label></th>
                        <td><input type="email" id="business_email" name="business_email" class="regular-text" value="<?php echo esc_attr( $d['business_email'] ?? '' ); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="price_range"><?php esc_html_e( 'Price Range', 'real-smart-seo' ); ?></label></th>
                        <td><input type="text" id="price_range" name="price_range" style="width:80px;" value="<?php echo esc_attr( $d['price_range'] ?? '$$' ); ?>" placeholder="$$"></td>
                    </tr>
                    <tr>
                        <th><label for="logo_url"><?php esc_html_e( 'Logo URL', 'real-smart-seo' ); ?></label></th>
                        <td><input type="url" id="logo_url" name="logo_url" class="large-text" value="<?php echo esc_attr( $d['logo_url'] ?? '' ); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="og_image_url"><?php esc_html_e( 'OG Image URL (1200×630)', 'real-smart-seo' ); ?></label></th>
                        <td><input type="url" id="og_image_url" name="og_image_url" class="large-text" value="<?php echo esc_attr( $d['og_image_url'] ?? '' ); ?>"></td>
                    </tr>
                </table>

                <h2><?php esc_html_e( 'Address (NAP)', 'real-smart-seo' ); ?></h2>
                <p class="description"><?php esc_html_e( 'Must match your Google Business Profile exactly — Name, Address, Phone consistency is a core local SEO signal.', 'real-smart-seo' ); ?></p>
                <table class="form-table">
                    <tr>
                        <th><label for="address_street"><?php esc_html_e( 'Street Address', 'real-smart-seo' ); ?></label></th>
                        <td><input type="text" id="address_street" name="address_street" class="regular-text" value="<?php echo esc_attr( $d['address_street'] ?? '' ); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="address_city"><?php esc_html_e( 'City', 'real-smart-seo' ); ?></label></th>
                        <td><input type="text" id="address_city" name="address_city" class="regular-text" value="<?php echo esc_attr( $d['address_city'] ?? '' ); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="address_state"><?php esc_html_e( 'State', 'real-smart-seo' ); ?></label></th>
                    ...
                    <tr>
                        <th><label for="address_zip"><?php esc_html_e( 'ZIP Code', 'real-smart-seo' ); ?></label></th>
                        <td><input type="text" id="address_zip" name="address_zip" style="width:100px;" value="<?php echo esc_attr( $d['address_zip'] ?? '' ); ?>"></td>
                    </tr>
                </table>

                <h2><?php esc_html_e( 'Service Areas', 'real-smart-seo' ); ?></h2>
                <table class="form-table">
                    <tr>
                        <th><label for="service_areas"><?php esc_html_e( 'Service Areas (one per line)', 'real-smart-seo' ); ?></label></th>
                        <td>
                            ...
                            <p class="description"><?php esc_html_e( 'These populate the areaServed schema field and appear in AI Overview citations.', 'real-smart-seo' ); ?></p>
                        </td>
                    </tr>
                </table>

                <h2><?php esc_html_e( 'sameAs Profiles', 'real-smart-seo' ); ?></h2>
                <p class="description"><?php esc_html_e( 'Add every claimed/verified profile URL. Google cross-references these to verify your business entity and consolidate authority across platforms.', 'real-smart-seo' ); ?></p>
                <table class="form-table">
                    <?php
                    $profiles = array(
                ...
                <p class="submit">
                    <button type="submit" name="rsseo_save_sameas" value="1" class="button button-primary"><?php esc_html_e( 'Save & Publish Schema', 'real-smart-seo' ); ?></button>
                </p>
            </form>

            <?php if ( get_option( 'rsseo_sameas_identity' ) ) : ?>
            <hr>
            <h2><?php esc_html_e( 'Live Schema Preview', 'real-smart-seo' ); ?></h2>
