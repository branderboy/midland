...
<div id="smart-chat-widget" class="smart-chat-<?php echo esc_attr( $position ); ?>" style="display:none;">
    ...
    <div id="smart-chat-window" style="display:none;">
        <div id="smart-chat-header" style="background:<?php echo $color; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;">
            ...
            <button id="smart-chat-expand-lg" type="button" aria-label="<?php esc_attr_e( 'Enlarge', 'smart-chat-ai' ); ?>" title="<?php esc_attr_e( 'Enlarge', 'smart-chat-ai' ); ?>">
            ...
            <button id="smart-chat-expand-sm" type="button" aria-label="<?php esc_attr_e( 'Enlarge', 'smart-chat-ai' ); ?>" title="<?php esc_attr_e( 'Enlarge', 'smart-chat-ai' ); ?>">
